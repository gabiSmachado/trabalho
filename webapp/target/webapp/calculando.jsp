<%@page import="calculadora.CalculandoBhaskara"%>
...
<body>
<jsp:useBean scope="page" id="cal" class="calculadora.CalculandoBhaskara"></jsp:useBean>
...
<div>
	<p>Raiz Negativa: <% out.print(cal.getRaizNegativa()); %></p>
</div>
</div>
</body>
</html>
